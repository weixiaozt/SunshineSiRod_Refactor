...
{
    internal class MoveControllerModbusTool
    {
        private static MoveControllerModbusTool _instance;
        private EasyModbus.ModbusClient _modbusClient;
        public string receiveData = null;

        public static MoveControllerModbusTool Instance()
        {
            if (null == _instance)
            {
                _instance = new MoveControllerModbusTool();
            }    
        ...
        private MoveControllerModbusTool()
        {
