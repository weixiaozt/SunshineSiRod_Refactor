    ...
    public class SSZNCamTools
    {
        ...
        private void SSZNCamTools_ShowImageLoopTop(bool topmost)
        {
            ...
            if (SettingParameter.Instance().NDaemon == 0)
            {
                ...
                HOperatorSet.ReadImage(out hObject, "D:/Image1/top/" + NMockTopIndex.ToString() + ".tif");
                NMockTopIndex++;
            }
            else
            {
        ...
        private void SSZNCamTools_ShowImageLoopRight(bool topmost)
        {
            ...
            if (SettingParameter.Instance().NDaemon == 0)
            {
                ...
                HOperatorSet.ReadImage(out hObject, "D:/Image1/right/" + NMockRightIndex.ToString() + ".tif");
                NMockRightIndex++;
            }
            else
            {
        ...
        private void SSZNCamTools_ShowImageLoopDown(bool topmost)
        {
            ...
            if (SettingParameter.Instance().NDaemon == 0)
            {
                HOperatorSet.ReadImage(out hObject, "D:/Image1/down/" + NMockDownIndex.ToString() + ".tif");
                NMockDownIndex++;
            }
            else
            {
        ...
        private void SSZNCamTools_ShowImageLoopLeft(bool topmost)
        {
            ...
            if (SettingParameter.Instance().NDaemon == 0)
            {
                HOperatorSet.ReadImage(out hObject, "D:/Image1/left/" + NMockLeftIndex.ToString() + ".tif");
                NMockLeftIndex++;
            }
            else
            {
                            ...
                            if (nWaitIndex >= 12)
                            {
                                ...
                                if (NLeftIndex >= 4 && NRightIndex >= 4 && NTopIndex >= 4 && NDownIndex >= 4)
                                {
                                    try
                                    {
                                        ...
                                        if (false == CGlobalSquareFuncToolsNew.Instance().checkSquareStickLengthInverseAscend(hobjectTopStick, hobjectLeftStick, hobjectRightStick, hobjectDownStick, hv_ResultdictHandle, out HTuple hv_StickLength, out HTuple hv_Surface3DDefaultTF, out HTuple hv_Surface3DDefaultTS, out HTuple hv_Surface3DDefaultTT, out HTuple hv_Surface3DDefaultDF, out HTuple hv_Surface3DDefaultDS, out HTuple hv_Surface3DDefaultDT, out HTuple hv_Surface3DDefaultLF, out HTuple hv_Surface3DDefaultLS, out HTuple hv_Surface3DDefaultLT, out HTuple hv_Surface3DDefaultRF, out HTuple hv_Surface3DDefaultRS, out HTuple hv_Surface3DDefaultRT, out HTuple hv_StickImageHeight, out HTuple hv_firstTopIndexRow, out HTuple hv_secondTopIndexRow, out HTuple hv_thirdTopIndexRow, out HTuple hv_firstDowntIndexRow, out HTuple hv_secondDownIndexRow, out HTuple hv_thirdDownIndexRow, out HTuple hv_firstRightIndexRow, out HTuple hv_secondRightIndexRow, out HTuple hv_thirdRightIndexRow, out HTuple hv_firstLeftIndexRow, out HTuple hv_secondLeftIndexRow, out HTuple hv_thirdLeftIndexRow))
                                        {
