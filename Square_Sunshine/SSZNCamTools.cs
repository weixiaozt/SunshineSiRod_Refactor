                                ...
                                try
                                {
                                    ...
                                    if (NLeftIndex >= 4 && NRightIndex >= 4 && NTopIndex >= 4 && NDownIndex >= 4)
                                    {
                                        ...
                                        try
                                        {
                                            ...
                                            HOperatorSet.CropPart(_ho_ImageLeft, out hObjectLeftReference, 3000, 0, 3200, 500);
                                            HOperatorSet.CropPart(_ho_ImageTop, out hObjectTopReference, 3000, 0, 3200, 500);
                                            HOperatorSet.CropPart(_ho_ImageRight, out hObjectRightReference, 3000, 0, 3200, 500);
                                            HOperatorSet.CropPart(_ho_ImageDown, out hObjectDownReference, 3000, 0, 3200, 500);
                                            ...
                                            CGlobalSquareFuncToolsNew.Instance().checkChamferDiagOnlyByHeight(hObjectTopReference, hv_fRatioT, out hv_RefDiagTopLength, out hv_RefLeftIndexesTop, out hv_RefRightIndexesTop, out hv_RefRowBeginTop, out hv_RefmeanHeightTopL, out hv_RefmeanHeightTopM, out hv_RefmeanHeightTopR, 2);

                                            CGlobalSquareFuncToolsNew.Instance().checkChamferDiagOnlyByHeight(hObjectLeftReference, hv_fRatioL, out hv_RefDiagLeftLength, out hv_RefLeftIndexesLeft, out hv_RefRightIndexesLeft, out hv_RefRowBeginLeft, out hv_RefmeanHeightLeftL, out hv_RefmeanHeightLeftM, out hv_RefmeanHeightLeftR, 2);


                                            CGlobalSquareFuncToolsNew.Instance().checkChamferDiagOnlyByHeight(hObjectRightReference, hv_fRatioR, out hv_RefDiagRightLength, out hv_RefLeftIndexesRight, out hv_RefRightIndexesRight, out hv_RefRowBeginRight, out hv_RefmeanHeightRightL, out hv_RefmeanHeightRightM, out hv_RefmeanHeightRightR, 2);

                                            CGlobalSquareFuncToolsNew.Instance().checkChamferDiagOnlyByHeight(hObjectDownReference, hv_fRatioD, out hv_RefDiagDownLength, out hv_RefLeftIndexesDown, out hv_RefRightIndexesDown, out hv_RefRowBeginDown, out hv_RefmeanHeightDownL, out hv_RefmeanHeightDownM, out hv_RefmeanHeightDownR, 2);
